...
sudo -u www-data wp-cli core install --url='http://jherrerog-wordpress.duckdns.org' --title='Soporte - jherrerog' --admin_user='admin' --admin_password='Admin123' --admin_email='jherrerog03@educantabria.es' --path='/var/www/html'
